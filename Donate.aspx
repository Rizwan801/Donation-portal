            ...
            <div class="col-lg-8 col-md-offset-2  ">
                <div class=" panel-donation">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-6">
                                <div class="button-right">
                                    <asp:Button ID="btn_other" CssClass="btn-donation other" runat="server" Text="       Other      "  OnClick="btn_other_Click"/>
                                    <h6>
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-12  ">
                                <div class="panel panel-form" style=" background-color:#fff;">
                                    <div class="panel-heading" style="background-color:#CC0033;">
                                        <div class="row">
                                            <div class="col-xs-6">

                                                <a href="#" class="active" id="card-form-link">
                                                    <img src="images/card.jpg" style="width: 70px; height: 60px; padding: 10px 10px; margin: 0 30%;" />VisaCard</a>
                                            </div>
                                            <div class="col-xs-6">
                                                <a href="#" id="mobile-form-link">
                                                    <img src="images/easypaisa.jpg" style="width: 70px; height: 60px; padding: 10px 10px; margin: 0 30%;" />EasyPaisa Account</a>
                                            </div>
                                        </div>
                                        <hr />
                                    </div>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form" id="card-form" style="display: block;">
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group">
                                                            <asp:TextBox ID="txtsecuritypin" runat="server" CssClass="txt-box form-control" PlaceHolder="Security Pin" TextMode="Password"></asp:TextBox>
                                                    ...
                                                    <div class="col-md-6">
                                                        <asp:Label ID="Label2" runat="server" Text="Billing Address" CssClass="auto-style271" ForeColor="Black"></asp:Label>
                                                        <div class="form-group">
                                                        ...
                                                        <asp:Label ID="Label3" runat="server" Text="Mobile Information" CssClass="auto-style272" ForeColor="Black"></asp:Label>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="col-sm-6 col-sm-offset-3">
                                                            <asp:Button ID="btn_donate" runat="server" CssClass="form-btn form-control  " Text="Donate Now" OnClick="btn_donate_Click"/>
                                                ...
                                                <div class="form mobile col-md-6 col-md-offset-3" id="mobileform" style="display: none;">  
                                                    <div class="form-group">
                                                           <asp:TextBox ID="txtamounteasy" runat="server" CssClass="form-control required txt-box " PlaceHolder="Amount in Rs:" TextMode="Number"></asp:TextBox> 
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6 col-sm-offset-3">
                                                        <asp:Button ID="donate" runat="server" CssClass="form-btn form-control  " Text="Donate Now" onclick="donate_Click"/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <asp:Panel ID="Panel2" runat="server">
                        ...
                        <div class="row">
                            <div class="col-md-8 col-md-offset-2 ">
                                <div class="panel panel-form" style=" background-color:#fff;">
                                    <div class="panel-heading" style="background-color:#CC0033;">
                                        <div class="row">
                                            <div class="col-xs-12">
                                                <asp:Label ID="Label1" runat="server" Text="Donte what you want" CssClass="auto-style273" Font-Bold="True" ForeColor="White"></asp:Label>
                                                    </div>
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-12  ">
                                                ...
                                                <h6>Contact With Focal Person On Following Address or Contact Number</h6>
                                                       <%-- <div class="form-group">
                                                            <asp:TextBox ID="txtthings" runat="server" CssClass="form-control required txt-box " PlaceHolder="Enter Things " ></asp:TextBox>
                                                        </div>--%>
                                                        <%--<asp:Button ID="other" runat="server" CssClass="form-btn form-control  " Text="Add" onclick="other_Click"/>--%>
                                               <%-- <div class="form-group">
                                                <asp:DropDownList ID="DropDownList1" runat="server" CssClass="form-control txt-box" Height="38px" >
                                                     <asp:ListItem>Contact With Focal Person On Following Address or Contact Number</asp:ListItem>
                                  </asp:DropDownList>
                                                    </div>
                                                       --%>
                                                <hr />
                            ...
                            <ul>
                                <li><i class="fa fa-phone" style="color:black;"></i><span>+92-061-6560 095</span></li>
                                <li><i class="fa fa-envelope" style="color:black;"></i><span>multan1@sparcpk.org</span></li>
                                <li><i class="fa fa-map-marker" style="color:black;"></i><span>House # 1, Near Al-Huda Hotel, Lari Adda,Vehari Chowk Multan</span></li>
                            </ul>
                        </div><!-- .foot-contact -->
